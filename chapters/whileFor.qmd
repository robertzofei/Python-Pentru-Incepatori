...
Putem face un bloc de cod sa se execute de mai multe ori folosind instructiunea `while`. Vom lua doua bucati de cod: una care contine o instructiune `if`, si alta care contine o instructiune `while`.

Ne uitam la doua bucati de cod.
...
Observam in scurt timp ca cele doua bucati de cod arata aproape identic, insa diferenta este la felul in care se comporta.

Codul din clauza `while` va continua sa se execute cat timp conditia este adevarata (True).
